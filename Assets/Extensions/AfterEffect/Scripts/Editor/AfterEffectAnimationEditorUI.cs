...
[CustomEditor(typeof(AfterEffectAnimationUi))]
public class AfterEffectAnimationEditorUI : Editor {
	...
	public override void OnInspectorGUI() {
		...
		foreach(Object t in targets) {
			(t as AfterEffectAnimationUi).timeScale = _timeScale;
		}
	...
	public AfterEffectAnimationUi anim {
		get {
			return target as AfterEffectAnimationUi;
		}
	}
	...
	protected void OnPivotPositionChnage() {
		serializedObject.ApplyModifiedProperties ();
		foreach(Object t in targets) {
			(t as AfterEffectAnimationUi).OnPivotPositionChnage ();
		}
	}
	...
	protected void OnEditorFrameChange() {
		serializedObject.ApplyModifiedProperties ();
		foreach(Object t in targets) {
			(t as AfterEffectAnimationUi).OnEditorFrameChange ();
		}
	}
	...
	protected virtual void ReloadAnimation() {
		serializedObject.ApplyModifiedProperties ();
		foreach(Object t in targets) {
			(t as AfterEffectAnimationUi).OnAnimationDataChange ();
		}
	}
