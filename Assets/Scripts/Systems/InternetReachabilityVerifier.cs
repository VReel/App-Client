...
public class InternetReachabilityVerifier : MonoBehaviour
{
    ...
    public float errorRetryDelay = 20.0f;
...
#               endif
            ...
            case CaptivePortalDetectionMethod.AppleHTTPS:
                ...
                int successPos = www.text.IndexOf("<BODY>Success</BODY>");
                if (successPos >= 0 && successPos < 50)
                    return true;
                break;
